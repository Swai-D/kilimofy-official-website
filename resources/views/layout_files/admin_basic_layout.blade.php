...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="index.html" class="logo"><b>T-<span>kilimo</span></b></a>
      <!--logo end-->
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
            ...
            <ul class="sub">
              <li><a href="/andika_chapisho_la_makala">Andika makala</a></li>
    ...
    <footer class="site-footer">
      <div class="text-center">
        <p>
          {{date('M, Y')}}&copy; Copyrights <strong>T-kilimo</strong>. All Rights Reserved
        </p>
        <div class="credits">
          <!--
